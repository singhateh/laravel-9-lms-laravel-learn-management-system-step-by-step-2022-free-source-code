...
@section('content')
    <div class="row">
                ...
                <div class="twt-feed blue-bg">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="text-white display-6">{{ $teacher->name }}</h3>
                            <p class="text-light">{{ $teacher->assignRoles() }}</p>
                        </div>
                    </div>
        ...
        <div class="col-md-8">
            <div class="card">
                {{-- <img class="card-img-top" src="{{ $teacher->image() }}" alt="{{ $teacher->name }}"> --}}
                <div class="card-body">
                    <h3 class="card-title mb-3">@lang('All Subscribed Courses') {{ count($teacher->courses) }}</h3>

                    <div class="accordion" id="accordionExample">
                        @forelse ($teacher->courses as $key => $course)
                            <div class="card">
                                <div class="title">
