                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-success">
                                                ...
                                                <input id="name" name="name" type="text"
                                                    value="{{ $user->name }}" class="form-control name valid"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-success">
                                                ...
                                                <input id="username" name="username" type="text"
                                                    value="{{ $user->username }}" class="form-control username valid"
                                                    data-val="true" data-val-required="{{ __('Please enter username') }}"
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" type="email"
                                                    value="{{ $user->email }}" class="form-control email identified visa"
                                                    value="" data-val="true"
